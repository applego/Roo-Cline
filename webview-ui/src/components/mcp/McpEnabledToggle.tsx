	...
	return (
		<div style={{ marginBottom: "20px" }}>
			...
			<p
				...
				When enabled, Roo will be able to interact with MCP servers for advanced functionality. If you&apos;re
				not using MCP, you can disable this to reduce Roo&apos;s token usage.
			</p>
		</div>
	)
}
